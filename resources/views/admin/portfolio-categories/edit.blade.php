...
<div class="container mx-auto px-4 py-8">
    ...
    <form action="{{ route('portfolio-categories.update', $portfolioCategory) }}" method="POST" class="max-w-md">
        @csrf
        @method('PUT')
        
        <div class="mb-6">
            <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Nombre</label>
            <input type="text" name="name" id="name" value="{{ old('name', $portfolioCategory->name) }}" 
